...
public class MongoDBConnectionHandler {
    ...
    public static FindIterable<Document> findInMongo(MongoCollection collection, Document doc){
        return collection.find(eq("_id", doc.getString("_id")));

    }

    public static void updateInMongo(MongoCollection collection, Document doc){
        collection.replaceOne(findInMongo(collection, doc).first(), doc);
    }
