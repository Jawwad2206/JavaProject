 ...
 */
public class main {
    public  static void main(String[] args) throws ParserConfigurationException, IOException, SAXException, WrongInputException, ParseException, UIMAException, JSONException {
        ...
        UserInterfaceSpark.main5(txtpath);
