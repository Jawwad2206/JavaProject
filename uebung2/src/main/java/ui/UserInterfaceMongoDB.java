...
public class UserInterfaceMongoDB {
     ...
     */
    public static void main3(String txtpath) throws ParserConfigurationException, IOException, WrongInputException, SAXException, ParseException {
     ...
     * @throws SAXException
     */
    public void MainMenu(String txtpath) throws ParserConfigurationException, IOException, SAXException, WrongInputException, ParseException {
...
//        }
        ...
        switch (CHOICE) {
            case 1:
                ...
                if (choice == 1) {
                    ...
                    if (options == 1) {
                        speakerSortedSpeeches(pCollection);
                        break;

                    }
                    if (options == 2) {
                        speakerSortedRange(pCollection);
                        break;
                    }
                }
                ...
                if (choice == 2) {
                    ...
                    if (options == 1) {
                        fraktionSortedSpeeches(pCollection);
                        break;
                    }
                    if (options == 2) {
                        fractionSortedRange(pCollection);
                        break;
                    }
                }
                ...
                if (choice == 3) {
                    ...
                    if (options == 1) {
                        partySortedSpeeches(pCollection);
                        break;

                    }
                    if (options == 2) {
                        partySortedRange(pCollection);
                        break;
            ...
            case 2:
                ...
                if (decisionAverageLength == 1) {
                    ...
                    Integer options = HelperFunctions.integerInputs(1, 2); //get the Input to perform an action listed above
                    if (options == 1) {
                        speakerAverageLength(pCollection);
                        break;

                    }
                    if (options == 2) {
                        speakerAverageRange(pCollection);
                        break;
                    }
                }
                if (decisionAverageLength == 2) {
                    ...
                    if (options == 1) {
                        fractionAverageLength(pCollection);
                        break;
                    }
                    if (options == 2) {
                        fractionAverageRange(pCollection);
                        break;
                    }
                }
                if (decisionAverageLength == 3) {
                    ...
                    Integer options = HelperFunctions.integerInputs(1, 2); //get an input to perfom an action listed above
                    if (options == 1) {
                        partyAverageLength(pCollection);
                        break;

                    }
                    if (options == 2) {
                        partyAverageRange(pCollection);
                        break;
                    }
                }
            case 3:
                ...
                Integer options = HelperFunctions.integerInputs(1, 2); //get an input to perfom an action listed above
                if (options == 1) {
                    durationAgenda(pCollection);
                    break;

                }
                if (options == 2) {
                    durationAgendaRange(pCollection);
                    break;
                }
                break;
            case 4:
    ...
    public static void speakerSortedSpeeches(MongoCollection collection){
        while (true) {
            try {
                ...
                try {
                    ...
                    MongoCursor<Document> cursor = collection.aggregate(countSpeechInquiry).cursor();//aggregates through the collection with the instructions in countSpeechInquiry
    ...
    public static void speakerSortedRange(MongoCollection collection){
        System.out.println("For this election Period: The first meeting was: 2017-10-23 and " +
                "the last meeting was: 2021-09-06");
        while (true) {
            try {
    ...
    public static void fraktionSortedSpeeches(MongoCollection collection){
        while (true) {
            try {
                System.out.println("For this election Period: The first meeting was: 2017-10-23 and " +
                        "the last meeting was: 2021-09-06\n");
                ...
                try {
                    ...
                    MongoCursor<Document> cursor = collection.aggregate(countFractionInquiry).cursor();//aggregates through the collection with the instructions in countSpeechInquiry
    ...
    public static void fractionSortedRange(MongoCollection collection){
        System.out.println("For this election Period: The first meeting was: 2017-10-23 and " +
                "the last meeting was: 2021-09-06");
        while (true) {
            try {
    ...
    public static void partySortedSpeeches(MongoCollection collection){
        while (true) {
            try {
                System.out.println("For this election Period: The first meeting was: 2017-10-23 and " +
                        "the last meeting was: 2021-09-06\n");
    ...
    public static void partySortedRange(MongoCollection collection){
        System.out.println("For this election Period: The first meeting was: 2017-10-23 and " +
                "the last meeting was: 2021-09-06");
        while (true) {
            try {
    ...
    public static void speakerAverageLength(MongoCollection collection){
        while (true) {
            try {
                System.out.println("For this election Period: The first meeting was: 2017-10-23 and " +
                        "the last meeting was: 2021-09-06\n");
    ...
    public static void speakerAverageRange(MongoCollection collection){
        System.out.println("For this election Period: The first meeting was: 2017-10-23 and " +
                "the last meeting was: 2021-09-06");
        while (true) {
            try {
    ...
    public static void fractionAverageLength(MongoCollection collection){
        try {
            System.out.println("For this election Period: The first meeting was: 2017-10-23 and " +
                    "the last meeting was: 2021-09-06\n");
            String date = HelperFunctions.dateInput(); // get a String input which will be the date
            ...
            try {
                ...
                MongoCursor<Document> cursor = collection.aggregate(averageSpeechLength).cursor();//aggregates through the collection with the instructions in countSpeechInquir
    ...
    public static void fractionAverageRange(MongoCollection collection){
        System.out.println("For this election Period: The first meeting was: 2017-10-23 and " +
                "the last meeting was: 2021-09-06");
        while (true) {
            try {
    ...
    public static void partyAverageLength(MongoCollection collection){
        try {
            String date = HelperFunctions.dateInput();// get a String input which will be the date
    ...
    public static void partyAverageRange(MongoCollection collection){
        System.out.println("For this election Period: The first meeting was: 2017-10-23 and " +
                "the last meeting was: 2021-09-06");
        while (true) {
            try {
    ...
    public static void durationAgenda(MongoCollection collection){
        while (true) {
            try {
                System.out.println("For this election Period: The first meeting was: 2017-10-23 and " +
                        "the last meeting was: 2021-09-06\n");
                ...
                try {
                    ...
                    MongoCursor<Document> cursor = collection.aggregate(getDuration).allowDiskUse(true).cursor(); // create a new Mongocursor and allowDiskUse (for unlimited memory usage)
                    while (cursor.hasNext()) {
                        Document document = cursor.next();
    ...
    public static void durationAgendaRange(MongoCollection collection){
        System.out.println("For this election Period: The first meeting was: 2017-10-23 and " +
                "the last meeting was: 2021-09-06");
        while (true) {
            try {
